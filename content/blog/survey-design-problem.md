...
Every so often, a survey pops up and asks if I am enjoying the experience. Not if it is working. Not if it helped me finish what I came to do. Not if it was clear, efficient, or reliable. “Are you enjoying this app?”

Enjoying it? No.

But that answer has nothing to do with whether the app is good. The question assumes I am here for delight. Usually, I'm not.
...
I am instantly annoyed and trying to complete a required step so I can move on. But it’s not a reflection of the quality of the system. It is a reflection of the situation it exists in. The survey just caught me at the worst possible moment and attempted to gather data on user sentiment.

### Compliance tools

Think about time tracking, medical systems, financial dashboards. No one opens these tools hoping for joy.
...
At that moment, the user is reacting to interruption, not evaluating the product holistically and that distinction matters.

## How does this question end up everywhere?

Part of the problem is not bad intent. It is inertia. Satisfaction surveys get copy pasted from product to product with very little reconsideration of what the tool actually does. A survey that made sense for a consumer app, marketing site, or content platform quietly becomes the default pattern for everything else.
...
NPS was created to measure loyalty and advocacy, not usability. It asks whether someone would recommend a product to others. That makes sense for products people choose to use. 

You cannot recommend something you are forced to use.
...
Older than all of the above, but somehow easier to forget, is task completion, error rates, time on task, and clarity questions. They shine in:
