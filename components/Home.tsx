      ...
      <div className="p-4 sm:p-0">
        <div className="relative mx-auto w-full max-w-[1920px] px-0 sm:px-6">
          ...
          <div className="relative flex min-h-[568px] flex-col items-center justify-center overflow-hidden rounded-3xl bg-[var(--surface)] px-6 py-24 sm:min-h-[85vh] sm:p-12">
            ...
            {/* HERO CONTENT */}
            <div
              className={` ${dmSans.className} relative z-10 w-full text-center text-zinc-900 `}
            >
              {/* EYEBROW */}
              <div className="mb-12 flex items-center justify-center gap-2 text-xs font-light uppercase tracking-[0.12em] text-zinc-600/60 sm:text-sm">
