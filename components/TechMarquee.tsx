...
export default function TechMarquee({
  ...
  return (
    <div
      ...
      style={{
        WebkitMaskImage:
          "linear-gradient(to right, transparent, transparent calc(max(24px, (100vw - 1500px) / 2 + 24px)), black calc(max(24px, (100vw - 1500px) / 2 + 24px) + 120px), black calc(min(100vw - 24px, 100vw - ((100vw - 1500px) / 2 + 24px)) - 120px), transparent calc(min(100vw - 24px, 100vw - ((100vw - 1500px) / 2 + 24px))), transparent)",
        maskImage:
          "linear-gradient(to right, transparent, transparent calc(max(24px, (100vw - 1500px) / 2 + 24px)), black calc(max(24px, (100vw - 1500px) / 2 + 24px) + 120px), black calc(min(100vw - 24px, 100vw - ((100vw - 1500px) / 2 + 24px)) - 120px), transparent calc(min(100vw - 24px, 100vw - ((100vw - 1500px) / 2 + 24px))), transparent)",
      }}
    >
